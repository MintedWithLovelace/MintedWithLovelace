...
import           SwapToken (swapTokenScript, swapTokenScriptShortBs)
...
main = do
  ...
  let scriptname = if nargs > 1 then args!!1 else  "swaptoken.plutus"
  putStrLn $ "OUTPUT: " ++ scriptname
  writePlutusScript scriptnum scriptname swapTokenScript swapTokenScriptShortBs
